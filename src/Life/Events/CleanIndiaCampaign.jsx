...
const CleanIndiaCampaign = () => {
  ...
  useEffect(() => {
    fetch(`${API_URL}/cleanindiacampaign-with-images`)
      .then((response) => {
  ...
  const centerMessage = loading
    ? "Loading Clean India Campaign activities..."
    : error
    ? error
  ...
  return (
    <>
      <Helmet>
        <title>Clean India Campaign - TIMSCDR</title>
        <meta name="description" content="Join our Clean India Campaign initiatives and environmental conservation programs at TIMSCDR." />
      </Helmet>
      ...
      {centerMessage ? (
        ...
        <div className="visit-main-container">
          <div className="visit-container">
            ...
            >
              <h1 className="visit-header">Clean India Campaign</h1>
                        ...
                        .map((img, idx) => (
                          <SwiperSlide key={idx}>
                            <img
                              ...
                              alt={`Clean India Campaign ${idx + 1}`}
...
export default CleanIndiaCampaign;