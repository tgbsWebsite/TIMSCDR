...
const ECellAyan = () => {
  ...
  useEffect(() => {
    fetch(`${API_URL}/ecell-with-images`)
      .then(res => {
  ...
  const centerMessage = loading ? "Loading E-Cell activities..." :
    error ? error :
      Object.keys(data).length === 0 ? "No activities found. Check back later." : null;
