            ...
            <div className='footer-container'>
                <div className='footer-logo-container'>
                    <iframe
                        ...
                        class="gmap" allowfullscreen="" loading="lazy"
                    ...
                    <div className='footer-socials'>
                        ...
                        <a href='https://www.youtube.com/@tgbs.mumbai'><img src='/images/icons/youtube.webp' alt='Youtube - TIMSCDR'/></a>
                    </div>
                </div>
                <div className='footer-contact-container'>
                    ...
                    <div className='footer-mail-container'>
                        ...
                        <a href="mailto:tgbs@thakureducation.org">timscdr@thakureducation.org</a>
                    </div>
